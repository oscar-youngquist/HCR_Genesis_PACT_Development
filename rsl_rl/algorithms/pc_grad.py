...
class PCGrad():
    ...
    def pc_backward(self, objectives):
        ...
        self._record_backward(grads, pc_grad, has_grads)
    ...
    def _project_conflicting(self, grads, has_grads, shapes=None):
        ...
        for g_i in pc_grad:
            ...
            for g_j in grads:
                ...
                if g_i_g_j < 0:
                    g_i -= (g_i_g_j) * g_j / g_j.square().sum().clamp_min(1.0e-12)
    ...
    def _project_conflicting_pinn(self, grads, has_grads, shapes=None):
        ...
        proj_coeff = torch.dot(g_R, g_P) / g_R.square().sum().clamp_min(1.0e-12)
    ...
    def _record_backward(self, objective_grads, merged_grad, has_grads):
        ...
        self.last_has_grads = tuple(
            mask.detach().clone() for mask in has_grads
        )
