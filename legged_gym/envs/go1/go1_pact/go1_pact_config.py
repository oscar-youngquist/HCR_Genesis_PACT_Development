...
class GO1PACTCfgPPO( LeggedRobotCfgPPO ):
    ...
    class runner( LeggedRobotCfgPPO.runner ):
        ...
        # debug_warmpinn_wb
        run_name = 'pact_100hz_entropydrop'
        experiment_name = 'go1_pact_rough'
        save_interval = 100
        
        
        load_run = "Mar10_12-59-21_pact_100hz_entropydrop"
        checkpoint = -1
        resume = False
        exp_data_path = "exp_data/quick_test/debugging_tests_fullmodel_discrete_payload.csv"