...
class GO1TauCfg( LeggedRobotCfg ):
    ...
    class termination:
        ...
        pitch_threshold   = 1.00  # [rad] ~ 40 degrees
        height_min = 0.20       # [m]
        height_max = 1.50       # [m]
...
class GO1TauCfgPPO( LeggedRobotCfgPPO ):
    seed = 1
    ...
    class runner( LeggedRobotCfgPPO.runner ):
        ...
        # debug_warmpinn_wb
        run_name = 'tau_100hz_spec_smartcurr'
        experiment_name = 'go1_tau_rough'
        save_interval = 100
