...
def qp_update_contract(mode, decimation, warmup_iterations=0, qp_config=None,
    ...
    result = {
        ...
        "velocity_tracking": {
            "version": 1, "command_order": ["body_vx_m_s", "body_vy_m_s", "body_omega_z_rad_s"],
            "prediction": "y_next=y_body+physics_dt*qdd_canonical[0,1,5]; body transport bias cancels",
            "command_source": "physical commands at sampled solve, after heading-to-yaw-rate conversion",
            "replay_required_when_enabled": ["velocity_command", "base_linear_velocity_world", "base_angular_velocity_world", "base_quaternion"],
            "semantics": "soft inner primary/recovery objective; independent of curricula; not an outer loss or execution guarantee",
        },
