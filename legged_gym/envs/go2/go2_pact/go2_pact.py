...
class Go2PACT(BaseTask):
    ...
    def check_termination(self):
        ...
        # Count consecutive failing control steps, not lifetime contact hits
        # or bitwise flags in an integer counter. A healthy step clears it.
    ...
    def compute_observations(self):
        ...
        self.explicit_labels_buf = torch.cat((
            ...
            self.simulator.link_contact_states[:,self.simulator.feet_contact_indices], # contact-sensor foot order 4
    ...
    def step_tradeoff_curriculum(self, env_ids):
        ...
        self.simulator.feedforward_tau_weight_clean[env_ids] = self.tradeoff_step_ctr[env_ids] *float(1.0/self.tradeoff_num_steps)*self.bound_diff[0] + self.tradeoff_lowerbounds[0]
        self.simulator.feedback_tau_weight_clean[env_ids]    = self.tradeoff_step_ctr[env_ids] *float(1.0/self.tradeoff_num_steps)*self.bound_diff[1] + self.tradeoff_lowerbounds[1]
    ...
    def _reward_stumble(self):
        ...
        contact_forces = self.simulator.link_contact_forces[:, self.simulator.feet_contact_indices, :]  # (N,4,3)
