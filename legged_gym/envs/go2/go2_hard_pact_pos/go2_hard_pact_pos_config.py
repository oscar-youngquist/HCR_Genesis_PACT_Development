"""Standalone Go2 HardPACTPos configuration.

All retained Go2 PACTPos settings and HardPACTPos-specific values are declared
in their owning classes below.  This module imports no legacy PACTPos config.
"""
...
# physics timestep only after Python has finished constructing GO2HardPACTPosCfg.
GO2HardPACTPosCfg.sim.dt = (
    GO2HardPACTPosCfg.control.dt / GO2HardPACTPosCfg.control.decimation
)
